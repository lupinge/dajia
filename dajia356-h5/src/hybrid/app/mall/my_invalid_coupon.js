...
var template    = require('./template/my_invalid_coupon.tpl');
var invalidCouponTpl    = require('./template/widget/my_invalid_coupon_list.tpl');
...
exports.loadMore = Widget.define({
    ...
    loadMore: function(){
        ...
        Service.get('discount/list', para, function (err, data) {
            ...
            self.config.$el.append(invalidCouponTpl({data: data.data, dateformat: dateformat}));
        });
